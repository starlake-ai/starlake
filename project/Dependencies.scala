...
object Dependencies {
  ...
  val azure = Seq(
    "org.apache.hadoop" % "hadoop-azure" % "3.3.5" % "provided" excludeAll (jacksonExclusions: _*) exclude ("com.google.guava", "guava"),
  ...
  val gcp = Seq(
    ...
    "com.google.cloud.spark" % "spark-bigquery-connector-common" % Versions.sparkBigqueryConnectorCommon % "provided" excludeAll (jacksonExclusions: _*),
