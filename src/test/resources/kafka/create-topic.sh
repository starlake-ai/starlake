bin/kafka-topics --bootstrap-server localhost:9092 --create --topic users --replication-factor 1 --partitions 1


bin/kafka-avro-console-producer --topic users --bootstrap-server localhost:9092 --property value.schema="$(< /Users/hayssams/git/public/starlake/src/test/resources/kafka/user.avsc)"
...
bin/kafka-avro-console-consumer --topic users --bootstrap-server localhost:9092  --from-beginning
