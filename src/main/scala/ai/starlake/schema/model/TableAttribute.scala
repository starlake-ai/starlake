...
object TableAttribute {
  ...
  // Merge operations extracted to AttributeMerger.scala — delegated for backward compatibility
  def mergeAll(
    ...
    AttributeMerger.mergeAll(refAttrs, sourceAttrs, attributeMergeStrategy)
}
