...
public class Setup extends ProxySelector implements X509TrustManager {
    ...
    private static final String SL_API_VERSION = getEnv("SL_API_VERSION").orElse("1.5.7-SNAPSHOT");

    private static final String SCALA_VERSION = getEnv("SCALA_VERSION").orElse("2.13");

    // STARLAKE
    private static final String SL_VERSION = getEnv("SL_VERSION").orElse("1.5.7-SNAPSHOT");
