export COMET_VERSION="${COMET_VERSION:-0.6.4-SNAPSHOT}"
...
initEnv() {
  ...
  awk -v var="$COMET_ROOT" '{sub("__SL_TEST_ROOT__", var)}1' ../quickstart-template/metadata/env.comet.yml >quickstart/metadata/env.comet.yml
