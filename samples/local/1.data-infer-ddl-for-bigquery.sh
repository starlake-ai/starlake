...
$SPARK_SUBMIT --driver-java-options "$SPARK_DRIVER_OPTIONS" $SPARK_CONF_OPTIONS $DRIVER_JAR --class $SL_MAIN $SL_JAR_FULL_NAME infer-ddl --datawarehouse bigquery --output /tmp/sql.txt #--apply
