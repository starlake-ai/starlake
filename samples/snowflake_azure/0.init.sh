...
azcopy copy application.conf "https://$AZURE_STORAGE_ACCOUNT.blob.core.windows.net/$AZURE_STORAGE_CONTAINER/mnt/starlake-app/quickstart/metadata/application.conf?$AZURE_STORAGE_SAS"
