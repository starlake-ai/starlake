...
gsutil cp ../../src/test/resources/sample/native/nativecustomers.psv gs://starlake-app/mnt/starlake-app/quickstart/datasets/pending/nativesales/nativecustomers.psv
gsutil cp /Users/hayssams/git/public/starlake/src/test/resources/sample/native/nativesales.sl.yml gs://starlake-app/mnt/starlake-app/quickstart/metadata/domains/nativesales.sl.yml
