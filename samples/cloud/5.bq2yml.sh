...
export SL_TABLEINFO_SINK_TYPE=BigQuerySink

$SPARK_SUBMIT --driver-java-options "$SPARK_DRIVER_OPTIONS" $SPARK_CONF_OPTIONS  --class $SL_MAIN $SL_JAR_FULL_NAME bq2yml
