...
## Entity relations
Using relationships may greatly improve readability and  query performance.
...
Starlake infer the lineage by analyzing the SQL queries. You can display tasks dependencies in text mode or in graph mode.
