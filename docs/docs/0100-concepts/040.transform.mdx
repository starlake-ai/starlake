...
- the generation of the insert / update / merge statement when needed
...
Starlake has been tested with BigQuery, Databricks, Snowflake, Postgres and Amazon Redshift.
It should work out of the box with any JDBC compliant database.
