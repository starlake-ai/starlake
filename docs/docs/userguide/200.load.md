...
Load rules are stored in the folder referenced by the SLK_METADATA
environment variable (/tmp/metadata by default).

:::note

You need to export the SLK_METADATA variable before executing any comet load step.

:::

``export SLK_METADATA=hdfs:///my/metadata``
...
Types are defined in the file $SLK_METADATA/types/types.comet.yml.
...
located in the file $SLK_METADATA/types/default.comet.yml and they may be redefined
in the file $SLK_METADATA/types/types.comet.yml

File ``$SLK_METADATA/types/default.comet.yml``
...
$SLK_METADATA/types/types.comet.yml
...
$SLK_METADATA/domains. They defined :
...
File ``$SLK_METADATA/domains/sales.yml``
...
aka $SLK_METADATA/domains/sales.yml.
...
File ``$SLK_METADATA/domains/hr.yml``
