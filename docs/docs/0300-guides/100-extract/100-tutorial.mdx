...
Download the [sample duckdb.db](https://github.com/starlake-ai/starlake/samples/starbake/datasets/duckdb.db) file and store it in the `datasets` folder in your project directory.
