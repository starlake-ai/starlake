...
and copy them to the `$SL_ROOT/incoming/starbake` folder using the following command:

```bash
$ cd $SL_ROOT
$ curl -O https://raw.githubusercontent.com/starlake-ai/starlake/master/samples/starbake/incoming/starbake/order_202403011414.json -O https://raw.githubusercontent.com/starlake-ai/starlake/master/samples/starbake/incoming/starbake/order_line_202403011415.csv -O https://raw.githubusercontent.com/starlake-ai/starlake/master/samples/starbake/incoming/starbake/product.xml
```
...
## Autoload
The autoload command is used to load the files in the incoming folder into the datawarehouse.
