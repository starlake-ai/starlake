...
val springBoot = Seq("org.springframework.boot" % "spring-boot" % Versions.springBoot,
...
libraryDependencies in ThisBuild ++= Seq(json4sNative, json4sJackson, scalaTest) ++ hadoop ++ springBoot ++ logging ++ pureConfig ++ spark
